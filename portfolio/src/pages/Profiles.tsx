...
const profiles = [
  {
    ...
    stats: [
      { label: "Repositories", value: "40+", icon: GitFork },
      { label: "Contributions", value: "500+", icon: Star },
      { label: "Stars Earned", value: "25+", icon: TrendingUp },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "Problems Solved", value: "300+", icon: Code2 },
      { label: "Contest Rating", value: "1500+", icon: TrendingUp },
      { label: "Global Rank", value: "Top 20%", icon: Award },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "Endorsements", value: "30+", icon: Award },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "Stars", value: "5 Star", icon: Star },
  ...
  },
  {
    platform: "CodeChef",
    icon: SiCodechef,
    handle: "@ankush_sharma",
    url: "#",
    description: "Long contests, short contests, and improving algorithmic thinking.",
    stats: [
      { label: "Rating", value: "1800+", icon: TrendingUp },
      { label: "Stars", value: "4 Star", icon: Star },
      { label: "Contests", value: "30+", icon: Award },
    ],
